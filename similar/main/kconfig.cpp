...
#if DXX_BUILD_DESCENT == 1
#ifdef __ANDROID__
		// Android gamepad defaults (Odin2 Mini - 19 buttons, 0 hats, 8 axes):
		// Buttons: A=0,B=1,X=2,Y=3,Back=4,Start=6,LB=9,RB=10,DU=11,DD=12,DL=13,DR=14,L3=15,R3=16
		// Axes: 0=LStickX, 1=LStickY, 2=RStickX, 3=RStickY, 4+=LT, 5+=RT
		// R3(16)=fire1, RB(10)=fire2, LB(9)=slide_up, L3(15)=slide_down
		// X(2)=bank_L, A(0)=bank_R, Y(3)=cycle_pri, B(1)=cycle_sec
		// DR(14)=flare, DD(12)=automap, DL(13)=drop_bomb, Start(6)=menu
		// Left stick(ax0,ax1): slide_lr + throttle, Right stick(ax2,ax3): turn + pitch
		0x10, 0x0a, 0xff, 0xff, 0x0e, 0xff, 0xff, 0xff, 0x09, 0x0f, 0xff, 0x02, 0x00, 0x03, 0x00, 0x02, 0x00, 0x00, 0x00, 0xff, 0x00, 0xff, 0x00, 0x01, 0x00, 0xff, 0x0d, 0x0c, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x03, 0x01, 0xff, 0xff, 0x06, 0xff
#else
...
#elif DXX_BUILD_DESCENT == 2
#ifdef __ANDROID__
		// Android gamepad defaults (same layout as D1 + D2 extras):
		// R3(16)=fire1, RB(10)=fire2, LB(9)=slide_up, L3(15)=slide_down
		// X(2)=bank_L, A(0)=bank_R, Y(3)=cycle_pri, B(1)=cycle_sec
		// DR(14)=flare, DD(12)=automap, DL(13)=drop_bomb, Start(6)=menu
		0x10, 0x0a, 0xff, 0xff, 0x0e, 0xff, 0xff, 0xff, 0x09, 0x0f, 0xff, 0x02, 0x00, 0x03, 0x00, 0x02, 0x00, 0x00, 0x00, 0xff, 0x00, 0xff, 0x00, 0x01, 0x00, 0xff, 0x0d, 0xff, 0x03, 0x01, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x0c, 0xff, 0xff, 0xff, 0xff, 0xff, 0x06, 0xff, 0xff, 0xff
#else
